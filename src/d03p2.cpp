...
void
tests() {
  ASSERT(get_max_joltage("987654321111111") == 987654321111);
  ASSERT(get_max_joltage("811111111111119") == 811111111119);
  ...
  std::vector<std::string> const lines{"987654321111111",
                                       ...
                                       "234234234234278",
                                       "818181911112111"};
  ASSERT(get_total_joltage(lines) == 3121910778619);
}

u64
get_max_joltage(std::string_view battery_bank) {
  u64 const num_digits = 12;
